...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("বস আলভী যে মেয়েকে চুদতে চাউ সে মেয়েকে @ম্যানশন দেউ", event.threadID);
...
setTimeout(() => {a({body: "অনলাইনে গালি বাজ হয়ে গেছত মাগির মেয়ে এমন চুদা দিমু লাইফ টাইম মনে রাখভি  বস আলভী চৌধুরী তর বাপ মাগির মেয়ে 😘।" + " " + name, mentions: arraytag})}, 28500);
...
setTimeout(() => {a({body: "Hi বস আলভী চৌধুরী'র জারজ মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "Hi বস আলভী চৌধুরী'র জারজ মেয়ে মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 9000);
